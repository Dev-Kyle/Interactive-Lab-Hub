...
try:
    player_sprite_raw = pygame.image.load('lunavator.png').convert_alpha()
except pygame.error as e:
    print(f"Unable to load image 'lunavator.png': {e}", file=sys.stderr)
    print("Please make sure the image file is in the same directory as the script.", file=sys.stderr)
    sys.exit()
